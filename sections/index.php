...
<?if(!startsWith($APPLICATION->GetCurDir(), "/sections/media/") || $APPLICATION->GetCurDir() == "/sections/media/"):?>
...
<?if(startsWith($APPLICATION->GetCurDir(), "/sections/media/")):?>
	...
	array(
		...
		"USE_SEARCH" => "N",
		"USE_SHARE" => "N",
		"COMPONENT_TEMPLATE" => "test-documents2",
