...
<?$APPLICATION->IncludeComponent("bitrix:main.include","",Array(
		"AREA_FILE_SHOW" => "file",
		"PATH" => SITE_DIR."include/documents_top_block.php",
...
$arSections = CIBlockSection::GetList(array("LEFT_MARGIN" => "ASC"), array("IBLOCK_ID" => $arParams["IBLOCK_ID"]
	)
)?>
...
<?while ($arSection = $arSections->Fetch()):?>
	...
	<?if ($rsElementsCount > 0 && $arSection['DEPTH_LEVEL']<=1):?>
		<?
...
//			}?>
<!--	"-->
<!--			   href="/razdely/media/--><?//=$arSection['CODE']?><!--/">--><?//=$arSection['NAME']?><!--</a></h2>-->
			...
			<div class="item">
				<div class="item-in">
					<div class="item-img img-middle ">
						<a href="/sections/media/<?=$arSection['CODE']?>/" class="item-img-in img-middle-in">
							<div style="background: url(<?=$img ?>) center/cover no-repeat; opacity: 1" class="img-hover-overlay"></div>
						</a>
					</div>
					<div class="item-content clearfix" style="height: 109px; overflow: hidden;">
						<div class="item-title">
							<a href="/sections/media/<?=$arSection['CODE']?>/"><?=$arSection['NAME']?></a>
						</div>
