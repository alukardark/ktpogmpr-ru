...
<?$arSections = CIBlockSection::GetList(
	array("SORT" => "ASC"),
	array("IBLOCK_ID" => $arParams["IBLOCK_ID"], 'CODE'=>"novosti-gmpr", "CODE"=>"novosti-ktpo-gmpr")
)
?>
<?while ($arSection = $arSections->Fetch()):?>
	...
	$rsElementsCount = CIBlockElement::GetList(
		array(),
		$arCountFilter,
		array(),
		false,
...
$arSections = CIBlockSection::GetList(
	array('created'=>true),
	array("IBLOCK_ID" => $arParams["IBLOCK_ID"], 'SECTION_ID'=>"37")
);
global $arFilter;
$arFilter = Array("IBLOCK_ID"=>31, "SECTION_ID"=>array(38, 40, 42, 43), "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y");
$res = CIBlockElement::GetList(Array('created'=>true), $arFilter, false, Array("nPageSize"=>50));

?>
<h2>Новости ГМПР</h2>
	<a href="/news/news-gmpr/" class="my-btn-news btn my-btn btn-sm my-btn-sm btn-default news-gmpr">Показать все</a>
