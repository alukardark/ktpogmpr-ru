...
<?
$arSections = CIBlockSection::GetList(array(), array("IBLOCK_ID" => $arParams["IBLOCK_ID"], "CODE" => $arResult["VARIABLES"]["SECTION_CODE"], "ACTIVE" => "Y"), false, array("ID", "NAME", "DESCRIPTION"));
?>
<?
$APPLICATION->IncludeComponent(
  "bitrix:news.list",
  "services_sections_new",
  Array(
    ...
    "DISPLAY_BUTTON"	=>	$arParams["DISPLAY_BUTTON"],
    "DISPLAY_VIEW"	=>	$arParams["DISPLAY_VIEW"],
    "DISPLAY_NAME"	=>	"Y",
...
<?
print_r($arResult["VARIABLES"]["PARENT_SECTION_CODE"]);
?>

<?
while ($arSection = $arSections->GetNext())
{
	$arSectionName = $arSection["NAME"];
	//$arSectionDescription = $arSection["DESCRIPTION"];
}
?>
...
<?if($arSectionDescription):?>
	<p><?=$arSectionDescription?></p>
<?endif?>
