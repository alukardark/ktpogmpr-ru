...
<!--		<div class="col col-back-btn"><a class="btn btn-default" href="--><?//=$arResult["FOLDER"].$arResult["URL_TEMPLATES"]["news"]?><!--"><i class="fa fa-angle-left"></i>--><?//=GetMessage("T_NEWS_DETAIL_BACK")?><!--</a></div>		-->
		<div class="col col-back-btn"><a class="btn btn-default" href="<?=$arResult["FOLDER"].$arResult['VARIABLES']['SECTION_CODE']."/"?>"><i class="fa fa-angle-left"></i><?=GetMessage("T_NEWS_DETAIL_BACK")?></a></div>
