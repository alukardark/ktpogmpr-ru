...
?>
<div class="clearfix bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?> <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo "bx-filter-vertical"?>">
	<div class="bx-filter-section panel panel-default">
		...
		<div class="panel-heading bx-filter-title bx-filter-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div>
