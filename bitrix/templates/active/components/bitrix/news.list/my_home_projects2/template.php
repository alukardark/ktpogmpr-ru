...
<div class="block-content-wrap clearfix" >
	<div class="block-content sc-maxwidth" style="padding-left: 0; padding-right: 0;">



		<div class="block-title title-button">

			<h2 class="my-adaptive-header">Новости КТПО ГМПР</h2><a href="<?=str_replace("#SITE_DIR#/", SITE_DIR, $arResult['SECTION']['PATH'][0]['SECTION_PAGE_URL'])?>" class="btn my-btn btn-sm my-btn-sm btn-default"><?=GetMessage('SERVICES_SLIDER_SHOW_ALL')?></a>
		</div>

		<div style="" class="my-content-slider content-slider items-list-slider s_arrows_top home-projects-slider"><a class="slick-arrow slick-prev">
				<!--				<i class="fa fa-angle-left"></i>-->
			</a><a class="slick-arrow slick-next">
				<!--				<i class="fa fa-angle-right"></i>-->
			</a>
			<div class="content-slider-in">
				<div class="my-news items-list clearfix items-view-slider img-or-3x2 services-list slider" data-per-row="<?=$arParams["ITEMS_PER_ROW"]?>">
