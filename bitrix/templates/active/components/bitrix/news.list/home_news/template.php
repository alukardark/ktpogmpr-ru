...
<div class="block-content-wrap clearfix">
	<div class="block-content sc-maxwidth">
		<div class="block-title title-button">
			<h2><?=GetMessage('NEWS_TITLE')?></h2><a href="<?=str_replace("#SITE_DIR#/", SITE_DIR, $arResult["LIST_PAGE_URL"])?>" class="btn btn-sm btn-default"><?=GetMessage('NEWS_ALL_TITLE')?></a>
		</div>
