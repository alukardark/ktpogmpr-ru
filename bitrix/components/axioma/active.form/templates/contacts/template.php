...
<?else:?>
		...
		<div class="row">
			<div class="col-sm-5 col-md-4">
				...
				<fieldset class="form-group <?if($arResult["ERROR_MESSAGE"]["PHONE"]):?>has-error<?endif?>">
					...
					<input id="contact-form-phone" type="text" name="user_phone" class="form-phone-middle form-control input-sm" value="<?=$arResult["AUTHOR_PHONE"]?>">
				</fieldset>
	...
	<script>
		$('#contact-form-phone').inputmask({"mask": "+7 (999) 999-9999",  "showMaskOnFocus": true, "showMaskOnHover": false, "clearIncomplete":  true});
	</script>
<?endif?>
