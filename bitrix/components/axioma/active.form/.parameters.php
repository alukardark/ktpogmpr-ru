...
$arFilter = Array("TYPE_ID" => "MS_FEEDBACK", "ACTIVE" => "Y");
if($site !== false)
	$arFilter["LID"] = $site;
...
$arComponentParameters = array(
	"PARAMETERS" => array(
		...
		"REQUIRED_FIELDS" => Array(
			...
			"TYPE"=>"LIST",
			"MULTIPLE"=>"Y",
			"VALUES" => Array("NONE" => GetMessage("MFP_ALL_REQ"), "NAME" => GetMessage("MFP_NAME"), "EMAIL" => "E-mail", "Subject" => "Subject", "MESSAGE" => GetMessage("MFP_MESSAGE")),
			"DEFAULT"=>"",
			"COLS"=>25,
			"PARENT" => "BASE",
		),
